...
export function buildSeedData(): AppData {
  ...
  return {
    ...
    schedules: [
      ...
      mk({ title: '机场大巴/快线 ×2', type: 'transport', location: '香港西九龙 → 机场', date: D0, startTime: '12:30', durationMin: 60, price: 81, varianceUp: 69, confirmed: true, note: '大巴 40.5；机场快线双人票好像人均 75。' }),
      mk({ title: 'HK-冲绳往返机票', type: 'transport', location: '香港国际机场', date: D0, startTime: '14:30', durationMin: 180, price: 2553, varianceUp: 500, confirmed: true, note: '9.30-10.6 或 10.2-10.7/8 两个窗口。' }),
      ...
      // —— 行程中 ——
      mk({ title: '吃饭预算（全程）', type: 'food', location: '全程', date: D1, startTime: '18:30', durationMin: 60, price: 1200, varianceUp: 300, confirmed: true, note: '1 日 2 餐，餐均 100。' }),
      ...
      mk({ title: '冲绳本岛-宫古往返机票', type: 'transport', location: '那霸机场', date: D4, startTime: '09:00', durationMin: 120, price: 748, varianceDown: 220, confirmed: true, note: '行程 1h，最便宜的 428 但是早 7 点，其他 700+ 的是下午。' }),
